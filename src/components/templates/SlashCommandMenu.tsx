...
export const isInlineCommand = (type: SlashCommandType): type is InlineCommandType => {
    return ["inlineHyperlink", "inlineFormula"].includes(type);
};
...
const slashCommands: SlashCommand[] = [
    ...
    },
    {
        id: "formulaBlock",
        label: "Formula Block",
        description: "Block-level math formula with coloured terms",
        icon: <Sigma className="h-4 w-4" />,
        keywords: ["formula", "math", "equation", "katex", "latex", "block"],
        category: "block",
    },
